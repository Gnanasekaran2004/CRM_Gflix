...
import com.pulsestream.entity.*;
import com.pulsestream.repository.*;
...
public class DataInitializer {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            // ==========================================
            // 1. Create Subscription Plans safely
            // ==========================================
            Plan basic = planRepository.findByName("Basic").orElseGet(() ->
            ...
            Plan standard = planRepository.findByName("Standard").orElseGet(() ->
                    planRepository.save(Plan.builder()
            ...
            Plan premium = planRepository.findByName("Premium").orElseGet(() ->
                    planRepository.save(Plan.builder()
